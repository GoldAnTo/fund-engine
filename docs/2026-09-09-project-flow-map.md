**Fund Engine 历史流程与实现逻辑（2026-09-09）**

> 本文保留当时的流程梳理。旧页面和七页原型已退役；后续以 `main` 的公司研究主线为开发基线，新前端另行设计。当前能力、分支取舍和验收边界见[2026-09-10 主线整合记录](2026-09-10-company-mainline-integration.md)。文中的旧入口和原型要求不作为当前实施指南。
