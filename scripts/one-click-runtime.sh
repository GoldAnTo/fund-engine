...
validate_one_click_runtime_profile() {
  ...
  validate_memory_limit ONE_CLICK_API_PROXY_MEMORY_LIMIT 256m
  ...
  validate_cpu_limit ONE_CLICK_API_PROXY_CPU_LIMIT 0.5
}
...
start_one_click_runtime() (
  ...
  compose stop api research-worker acquisition-worker company-research-worker api-proxy \
