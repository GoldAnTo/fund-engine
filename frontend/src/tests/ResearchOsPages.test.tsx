...
describe("Research OS event entry", () => {
  ...
  it("keeps reviewed claims, market observations and disclosed fund holdings in separate layers", async () => {
                    ...
                    factors: [
                      {
                        ...
                        forecast_verdict: {
                          id: "forecast-verdict-1",
                          outcome: "contradicted",
                          decision: "confirmed",
                          metric_name: "归母净利润",
                          baseline_value: 315000000,
                          expected_value: 455000000,
                          actual_value: 247245713.03,
                          unit: "CNY",
                          forecast_period_start: "2023-01-01",
                          forecast_period_end: "2023-12-31",
                          comparator: "within_tolerance",
                          relative_tolerance: 0.1,
                          rule_version: "forecast-numeric-v1",
                          rationale: "实际值不满足冻结容差。",
                          reviewed_by: "human:reviewer",
                          reason: "年报实际值显著低于冻结预测，确认未兑现。",
                          reviewed_at: "2026-08-10T00:00:00Z",
                          forecast_source: {
                            source_statement_id: "statement-forecast",
                            document_version_id: "doc-forecast",
                            document_title: "历史研报",
                            source_url: "https://example.test/forecast",
                            locator: { page: 1 },
                            available_at: "2023-04-25T00:00:00Z",
                            permission_status: "admitted",
                          },
                          baseline_source: null,
                          actual_source: {
                            source_statement_id: "statement-actual",
                            document_version_id: "doc-annual",
                            document_title: "年度报告",
                            source_url: "https://example.test/annual",
                            locator: { page: 123 },
                            available_at: "2024-04-22T00:00:00Z",
                            permission_status: "admitted",
                          },
                        },
                      },
    ...
    expect(screen.getAllByText("出现反证")).toHaveLength(2);
    expect(screen.getByText("人工已审核 · human:reviewer")).toBeVisible();
    expect(screen.getByText(/预测 455,000,000 CNY/)).toBeVisible();
    expect(screen.getByText("年报实际值显著低于冻结预测，确认未兑现。")).toBeVisible();
    expect(screen.getByRole("link", { name: "实际公告原文" })).toHaveAttribute(
      "href",
      "/events/event-tsm/documents?document=doc-annual",
    );
