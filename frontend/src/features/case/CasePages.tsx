...
function CaseDocumentsContent({ caseId }: { caseId: string }) {
  ...
  function beginRecovery(documentId: string) {
    setSearchParams(encodeRecoveryRouteState({ documentId, reason: "parse_failed" }));
  }
