...
function RunCard({ run, onOpen }: { run: ResearchRunArchive; onOpen: () => void }) {
  ...
  return <article className="ros-global-run">
    ...
    <dl className="ros-global-run__scope">
      ...
      <div><dt>执行频率</dt><dd>{scope.frequency ?? "本次未记录"}</dd></div>
