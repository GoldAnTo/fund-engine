...
export interface paths {
    ...
    "/api/v1/automatic-research/uploaded": {
        ...
        put?: never;
        /**
         * Start Automatic Research From Uploaded Original
         * @description Queue automatic research from exactly one immutable uploaded original.
         */
        post: operations["start_automatic_research_from_uploaded_original_api_v1_automatic_research_uploaded_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        AutomaticResearchActivityDTO: {
            ...
            count: number;
            /** Technical Details */
            technical_details: components["schemas"]["AutomaticResearchActivityDetailDTO"][];
        };
        ...
        AutomaticResearchFactorDTO: {
             ...
             * @enum {string}
             */
            classification: "key" | "secondary" | "pending" | "excluded";
            /** Ranking Reason */
        ...
        AutomaticResearchNarrativeDTO: {
            ...
            /** Estimated Remaining Seconds Min */
            estimated_remaining_seconds_min?: number | null;
            /** Estimated Remaining Seconds Max */
        ...
        AutomaticResearchViewDTO: {
            ...
            narrative: components["schemas"]["AutomaticResearchNarrativeDTO"];
            /** Activities */
            activities: components["schemas"]["AutomaticResearchActivityDTO"][];
            /** Exceptions */
            exceptions: components["schemas"]["AutomaticResearchExceptionDTO"][];
            /** Factors */
            factors: components["schemas"]["AutomaticResearchFactorDTO"][];
            /** Failure Reason */
        ...
        /** Body_start_automatic_research_from_uploaded_original_api_v1_automatic_research_uploaded_post */
        Body_start_automatic_research_from_uploaded_original_api_v1_automatic_research_uploaded_post: {
            /** Input */
            input?: string | null;
            /** File */
...
export interface operations {
    ...
    start_automatic_research_from_uploaded_original_api_v1_automatic_research_uploaded_post: {
        parameters: {
            query?: never;
            header?: {
                authorization?: string | null;
        ...
        requestBody: {
            content: {
                "multipart/form-data": components["schemas"]["Body_start_automatic_research_from_uploaded_original_api_v1_automatic_research_uploaded_post"];
            };
        };
        responses: {
            /** @description Successful Response */
