...
export interface paths {
    ...
    "/api/v1/forecast-targets/{target_id}/actual-metric-observations": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        post: operations["record_actual_metric_observation_api_v1_forecast_targets__target_id__actual_metric_observations_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/research-cases/{case_id}/forecast-verdicts": {
        ...
        /** List Forecast Verdicts */
        get: operations["list_forecast_verdicts_api_v1_research_cases__case_id__forecast_verdicts_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
        ...
        CreateForecastTargetRequest: {
            ...
            /** Relative Tolerance */
            relative_tolerance?: number | string | null;
            /** Reviewed By */
            reviewed_by: string;
            /** Review Reason */
        ...
        KeyFactorDTO: {
            ...
            forecast_verdict: components["schemas"]["ForecastVerdictSummaryDTO"] | null;
        };
        /**
         * KeyFactorRowDTO
...
export interface operations {
    ...
    record_actual_metric_observation_api_v1_forecast_targets__target_id__actual_metric_observations_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    list_forecast_verdicts_api_v1_research_cases__case_id__forecast_verdicts_get: {
        parameters: {
            query: {
                cutoff: string;
            };
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ForecastVerdictsResponse"];
                };
            };
            /** @description Validation Error */
            422: {
