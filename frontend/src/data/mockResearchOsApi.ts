...
export class MockResearchOsApi implements ResearchOsApi {
  ...
  private eventRunRecord(projection: EventRunProjection) {
    ...
    return {
      ...
      processed_count: workbench
        ? workbench.progress.reviewedCount
          + workbench.progress.automaticallyAdmittedCount
          + workbench.progress.pending
        : 2,
  ...
  async session(): ReturnType<ResearchOsApi["session"]> {
    ...
    return {
      ...
      tenant_id: "demo-team",
      roles: [],
      issuer: "https://identity.invalid/mock-realm",
  ...
  async admitLegacyCase(
    ...
    return {
      ...
      admitted_by: "user:mock-researcher",
      reason: input.reason,
      admitted_at: now,
    };
  }
  ...
  async saveMonitor(
    ...
    const next: Monitor = {
      ...
      budget: input.budget,
      changed_by: "user:mock-researcher",
          ...
          positions: [
            {
              ...
              filing_kind: "annual",
              supersedes_disclosure_id: "disclosure-demo-2026q2",
              supersedes_filing_kind: "quarterly",
              supersedes_published_at: "2026-07-20T00:00:00Z",
            },
          ],
        },
      ],
  ...
  async createForecastTarget(
    ...
    const record: Schemas["ForecastTargetDTO"] = {
      ...
      reviewed_by: "user:mock-researcher", review_reason: input.review_reason, reviewed_at: now,
  ...
  async recordActualMetricObservation(
    ...
    const record: Schemas["ActualMetricObservationDTO"] = {
      ...
      available_at: input.available_at, recorded_by: "user:mock-researcher",
  ...
  async createForecastVerdict(
    ...
    const record: Schemas["ForecastVerdictDTO"] = {
      ...
      reason: input.reason, reviewed_by: "user:mock-researcher", reviewed_at: now,
  ...
  async startKeyFactorCandidateRun(
    ...
    const run: Schemas["KeyFactorCandidateRunDTO"] = {
      ...
      requested_by: "user:mock-researcher",
  ...
  async createMarketInstrumentBinding(
    ...
    const created: Schemas["MarketInstrumentBindingDTO"] = {
      ...
      reviewed_by: "user:mock-researcher",
  ...
  async metrics(
    _options?: Parameters<ResearchOsApi["metrics"]>[0],
  ): ReturnType<ResearchOsApi["metrics"]> {
    return metrics;
  }
  async createMetric(
    ...
    const created = {
      ...
      approved_by: "user:mock-researcher",
      reason: input.reason,
      created_at: now,
    };
  ...
  async mechanismTemplates(
    _options?: Parameters<ResearchOsApi["mechanismTemplates"]>[0],
  ): ReturnType<ResearchOsApi["mechanismTemplates"]> {
    return [template];
  }
  async caseMechanismProtocol(
    caseId: string,
    _options?: Parameters<ResearchOsApi["caseMechanismProtocol"]>[1],
  ...
  async createAtomicClaim(
    ...
    const created: AtomicClaim = {
      ...
      structured_fields: {
        ...
        scope: input.scope ?? {},
        run_ref: "human:source-reader:user:mock-researcher",
      },
    };
