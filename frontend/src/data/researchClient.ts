...
export const researchClient: ResearchClient = {
  ...
  getReportResearchIntake: (caseId) => _client.getReportResearchIntake!(caseId),
  ...
  getReportEmbedWiki: (caseId, token) => _client.getReportEmbedWiki!(caseId, token),
  reviewEventImpactRelation: (input) => _client.reviewEventImpactRelation!(input),
