"""Dump the FastAPI OpenAPI spec to contracts/openapi.json.

Run from the repo root after backend schema changes so the API contract
...
touching the default API contract file.
"""
