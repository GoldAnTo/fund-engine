...
@pytest.mark.pg_only
def test_0052_postgres_backfill_restores_source_contract_immutability() -> None:
    database_url = os.environ["TEST_DATABASE_URL"]
    schema = f"source_contract_0052_{uuid.uuid4().hex}"
    ...
    try:
        ...
        upgraded_to_0052 = subprocess.run(
        ...
        assert upgraded_to_0052.returncode == 0, upgraded_to_0052.stderr
