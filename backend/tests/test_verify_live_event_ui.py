...
def test_live_event_ui_verifier_creates_and_reads_a_case_through_default_http_client() -> None:
    ...
    assert "PASS: default frontend created and listed the same Case through the live API" in result.stdout
