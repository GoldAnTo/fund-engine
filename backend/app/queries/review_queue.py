    ...
    def _pending_proposals(
        ...
        *,
        ...
        query = (
            ...
            .join(
                CaseTenantAdmission,
                CaseTenantAdmission.research_case_id == Proposal.research_case_id,
            )
            .where(Proposal.status == "pending")
            .where(CaseTenantAdmission.tenant_id == tenant_id)
            .where(Proposal.research_case_id.in_(authorized_case_ids))
        )
    ...
    def _legacy_links(
        ...
        *,
        ...
        query = (
            ...
            .join(
                CaseTenantAdmission,
                CaseTenantAdmission.research_case_id == Thesis.research_case_id,
            )
            .join(
                SourceStatement,
            ...
            .where(CaseTenantAdmission.tenant_id == tenant_id)
            .where(Thesis.research_case_id.in_(authorized_case_ids))
