...
# Provider reasoning output can otherwise consume the whole request deadline
# before the JSON answer is emitted.  Keep responses bounded for every
# review-gated operation; callers need concise atomic outputs, not essays.
...
class LLMClient:
    ...
    def from_env(cls) -> "LLMClient":
        ...
        - ``LLM_MAX_OUTPUT_TOKENS`` (default 512): bounds generated reasoning
          and JSON output so an extraction cannot consume its entire request
